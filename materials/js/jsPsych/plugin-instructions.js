  ...
  class InstructionsPlugin {
      ...
      trial(display_element, trial) {
          ...
          function btnListener(evt) {
            if (that.jsPsych.opts.log_data_for_replay) {that.jsPsych.replay_module.replay_event_handler(evt, that.jsPsych.global_trial_index, true)}
      ...
      create_simulation_data(trial, simulation_options) {
          ...
          while (curr_page !== trial.pages.length) {
              let view_time
              if (simulation_options.data.rt === undefined) {
                view_time = this.jsPsych.randomization.sampleExGaussian(3000, 300, 1 / 300);
              } else {
                view_time = this.jsPsych.randomization.sampleExGaussian(simulation_options.data.rt, simulation_options.data.rt*0.1, 1 / (simulation_options.data.rt*0.1));
              }

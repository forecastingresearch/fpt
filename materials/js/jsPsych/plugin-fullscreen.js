var jsPsychFullscreen = (function (jspsych) {
  ...
  class FullscreenPlugin {
    ...
    `;
          display_element.querySelector("#jspsych-fullscreen-btn").addEventListener("click", (e) => {
              if (this.jsPsych.opts.log_data_for_replay) {this.jsPsych.replay_module.replay_event_handler(e, this.jsPsych.global_trial_index, true)}
      ...
      simulate_visual(trial, simulation_options, load_callback) {
          ...
          if (data.success === false) {
              ...
              load_callback();
              this.jsPsych.pluginAPI.clickTarget(display_element.querySelector("#jspsych-fullscreen-btn"), this.jsPsych.randomization.sampleExGaussian(simulation_options.data.rt, simulation_options.data.rt*0.1, 1 / (simulation_options.data.rt*0.1), true));
          }
      }
  }

export default class Shipley_Vocab {
    ...
    define_trials() {
        ...
        self.general_instructions = {
            ...
            pages: [`<p style="font-size: 2em; text-align: center; font-weight: bold; color: red; line-height: 1.5;">SHIPLEY (VOCABULARY) MATERIAL SHOULD GO HERE, BUT IS COPYRIGHT PROTECTED BY WESTERN PSYCHOLOGICAL SERVICES AND UNAVAILABLE FOR REPRODUCTION</p>`],
